...
1. **Buat halaman About**  
   Berisi deskripsi diri atau portfolio.  

2. **Buat halaman Contact**  
   Berisi form input seperti nama, email, dan pesan.  

3. **Upload ke GitHub**  
   - Buat repository baru bernama **Lab4Web**.  
   - Masukkan semua file hasil praktikum dan **README.md** ini.  
   - Sertakan screenshot hasil tiap langkah.  
